//package com.example.tugasmkpb_1
...
import com.samsul.aplikasiprofil.databinding.ActivityMainBinding
class MainActivity : AppCompatActivity() {
    ...
    private fun validasiInput(){
        ...
        when{
            namaInput.isEmpty() -> mainBinding.edtName.error = "Nama
            tidak boleh kosong"
                genderInput.equals("Pilih Jenis Kelamin", ignoreCase = true)
            -> tampilToast("Jenis Kelamin harus dipilih")
            emailInput.isEmpty() -> mainBinding.edtEmail.error = "Email
            tidak boleh kosong"
                telpInput.isEmpty() -> mainBinding.edtTelp.error = "Telp
            tidak boleh kosong"
